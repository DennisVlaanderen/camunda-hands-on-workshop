...
public class SendRequestForDriverLicenseExTaskTest {

    private SendRequestForDriverLicenseExTask sut;

    @BeforeEach
    public void setup(){
        sut = new SendRequestForDriverLicenseExTask();
    }

    @Test
    public void whenSendRequestExecuteCalledWithPassingVariablesVerifyCompleteGetsExecuted() {
